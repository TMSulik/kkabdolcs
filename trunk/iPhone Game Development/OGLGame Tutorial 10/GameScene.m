...
- (id)init {
	...
	if(self == [super init]) {
		...
		// Init controls
		_pauseButton = [(Image*)[Image alloc] initWithImage:@"pause.png" filter:GL_LINEAR];
		_pauseOverlay = [(Image*)[Image alloc] initWithImage:@"paused.png" filter:GL_LINEAR];
        ...
        _joyPad = [(Image*)[Image alloc] initWithImage:@"joypad.png"];
        [_joyPad setAlpha:0.5f];
        _joyPadX = 55;
        _joyPadY = 55;
        
        _firebutton = [(Image*)[Image alloc] initWithImage:@"fire-button-1.png"];
