...
- (void)update:(GLfloat)aDelta {
    ...
    if(!_gotScene) {
        ...
        // Grab the tilewidth and height from the map which is being used within the game scene
        _tileWidth = [(GameScene*)[_sharedDirector currentScene] tileMap].tileWidth;
        _tileHeight = [(GameScene*)[_sharedDirector currentScene] tileMap].tileHeight;
        _gotScene = YES;
    }
