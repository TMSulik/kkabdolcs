...
- (void)initGame {
	...
	font1 = [[AngelCodeFont alloc] initWithFontImageNamed:@"font1.png" controlFile:@"font1" scale:3.0 filter:GL_LINEAR];
...
- (void)renderScene {
	...
	[sprite renderAtPoint:CGPointMake(160, 50) centerOfImage:NO];
	[font1 drawStringAt:CGPointMake(messageX, 0) text:message];
