...
//  iPhoneGame
//
//  Created by Seonghyeon Choe on 1/25/10.
...
- (int)horizontalSpriteCount {
	// Return how many horizontal sprites are in this spritesheet
	int horizontal = ([image imageWidth] - spriteWidth) / (spriteWidth + spacing) + 1;
	return horizontal;
}


- (int)verticalSpriteCount {
	// Return how many vertical sprites are in this spritesheet
	int vertical =  ([image imageHeight] - spriteHeight) / (spriteHeight + spacing) + 1;
